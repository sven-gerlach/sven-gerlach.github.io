        ...
        <NavbarStyled bg="light" expand="sm" collapseOnSelect='true' fixed='top'>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ml-auto">
              ...
              <LinkStyled activeClass='active' className='element my-auto mx-2 nav-link' to='planning' spy={true} smooth='easeInOutQuad' duration={1500} offset={-100} >Planning</LinkStyled>
